 ...
 * 2. 根据 [navigationBarDestinations] 算出首页路由。
 * 3. 使用 [Scaffold] 的 bottomBar 承载底栏，并把 contentPadding 交给业务页面。
 *
 * @param navigationBarDestinations 底栏数据，包括文案、图标、路由和默认项。
 * @param navigationBarModifier 只作用于底栏，适合设置底栏自身的 padding、阴影或形状。
