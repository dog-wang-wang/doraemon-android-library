package com.doraemon.foundation.screen.activity
...
import com.doraemon.foundation.nav.router.navWithActionAndOptions
import com.doraemon.foundation.screen.config.SharedAnimationConfig
import com.doraemon.foundation.screen.controller.SharedAnimationController
import kotlinx.coroutines.launch

/**
 * 边到边AppCompatActivity
 */
open class EdgeToEdgeAppCompatActivity : AppCompatActivity(), BaseActivityInterface {
    // 管理共享元素动画的控制器
